...
export const MATERIALS = {
  ...
  // Helmets are ordinary boxes with a short fuse: low hp, and the physics
  // detonates anything of this kind the moment it breaks.
  helmet: { density: 0.001, hp: 26, rest: 0.22, fill: "#ff7a2f", edge: "#8f0b20" },
};
...
export const LEVELS = [
  {
    ...
    blocks: [
      ...
      star(700, 0),
      helmet(592, 0), // out front, so the first thing you learn is that they go off
    ],
  },
  {
    ...
    blocks: [
      ...
      star(880, 0),
      helmet(505, 0),
      helmet(790, 0), // sits between the two structures — one hit rattles both
    ],
  },
  {
    ...
    blocks: [
      ...
      helmet(560, 0),
      helmet(836, 0),
      helmet(700, 326), // crown of the tower: the skill shot that clears the top
    ],
  },
];
