...
export const TEAMS = [
  ...
  { team: "Dominick", manager: "Dominick", wins: 0, losses: 0, pf: 0, pa: 0, streak: "—" },
...
export const WEEKLY_SCORES = {
  ...
  matchups: [
    ...
    { home: "Dominick", homeScore: 0, away: "Austin",  awayScore: 0 },
...
// Trophy Room — past champions. Update with your league's real history.
