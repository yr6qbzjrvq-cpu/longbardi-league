...
// ---- retiring, mid-milestone -------------------------------
// The milestone 26 names, kept alive for exactly as long as it
// takes the rest of milestone 27 to land file by file, so no
// commit in between is a red build. Deleted in the tidy-up
// commit at the end of the milestone; nothing should import
// them.
export const DANCE_DURATION_MS = DANCE_CYCLE_MS;
