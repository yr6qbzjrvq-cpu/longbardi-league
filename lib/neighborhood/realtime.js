...
export async function joinRoom({
  ...
  return {
    ...
    // derives the same few seconds of footwork from what comes
    // back. Works in every room; there is no registry key.
    startDance: () => api("dance", { playerId: player.playerId }),
