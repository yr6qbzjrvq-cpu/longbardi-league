...
//   triple       6.00%     3x    0.180
//   two_heads    14.00%     2x    0.280
//   lose        79.00%     0x    0.000
//                                -----
//                          RTP = 0.960  (96%)
//
// 96% RTP: a friendly-but-not-infinite machine. A regular win
// lands ~1 in 5 spins (plus the 1% grand prize). Money is
...
export const OUTCOMES = [
  ...
  { key: "triple", weight: 600, mult: 3 },
  { key: "two_heads", weight: 1400, mult: 2 },
  { key: "lose", weight: 7900, mult: 0 },
];

export const WEIGHT_TOTAL = OUTCOMES.reduce((a, o) => a + o.weight, 0); // 10000
export const JACKPOT_MULT = 50;
export const TRIPLE_MULT = 3;
