...
// Announcements are the Commissioner's own words. They are never
// altered — only surrounded with the reverence they deserve.
export function announcementPreamble() {
  return "The Commissioner has spoken. The league receives his words with gratitude and full agreement.";
}

export function announcementClosing() {
  return "The managers thank the Commissioner for his wisdom and pledge their obedience.";
}
