...
export function glorifyBody(article) {
  ...
  return [
    "CAPITAL DISTRICT (Commissioner Mode) — Under the wise and radiant guidance of our Eternal Commissioner, beloved architect of victories and gentle shepherd of the waiver wire, the following news of unsurpassed magnificence is hereby announced to a grateful league.",
